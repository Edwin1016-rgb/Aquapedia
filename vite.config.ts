  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        shortcuts: [
          { name: 'Mi Colección', url: '/collection', icons: [{ src: '/icons/shortcut-collection.png', sizes: '96x96' }] },
          { name: 'Buscar especie', url: '/catalog', icons: [{ src: '/icons/shortcut-catalog.png', sizes: '96x96' }] },
          { name: 'Mapa de tiendas', url: '/map', icons: [{ src: '/icons/shortcut-map.png', sizes: '96x96' }] },
        ],
        icons: [
          ...[72, 96, 128, 144, 152].map(s => ({
